...
function checkColumns() {
let firstdiagnolResult = isTicTacToe(board[2][0], board[1][1],board[0][2])
let seconddiagnolResult = isTicTacToe(board[0][0],board[1][1],board[2][2])
if(firstdiagnolResult !=)
}
